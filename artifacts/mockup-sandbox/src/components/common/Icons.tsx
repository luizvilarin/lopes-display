...
export const Icons = {
  ...
  Rocket: ({ size = 20, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.71-2.13.09-3.05a3.11 3.11 0 0 0-3.09.05Z"/><path d="M15 12c-1.5 0-3 1.5-3 3s1.5 3 3 3 3-1.5 3-3-1.5-3-3-3Z"/><path d="m19 5-3 3"/><path d="m14 10-2 2"/><path d="m9 15-2 2"/><path d="M21 3c-5 0-11 7-11 11s7 11 11 11 11-7 11-11-7-11-11-11Z"/>
    </svg>
  ),
