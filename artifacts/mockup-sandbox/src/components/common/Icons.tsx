...
/**
 * Modern, clean SVG icons for the Lopes platform.
 * Consistent stroke width and simplified geometry.
 */
export const Icons = {
  // Navigation
  ...
  Trophy: ({ size = 20, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55.47.98.97 1.21C11.47 18.44 12 19 12 19s.53-.56 1.03-.79c.5-.23.97-.66.97-1.21v-2.34c0-4.66-1.5-6.66-4-6.66H10"/><path d="M6 4h12v5c0 3.33-2 6.66-6 6.66S6 12.33 6 9V4Z"/>
    </svg>
  ),
